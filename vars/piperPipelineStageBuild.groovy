    ...
    piperStageWrapper (script: script, stageName: stageName) {
        ...
        durationMeasure(script: script, measurementName: 'build_duration') {
            ...
            try {
				...
				publishCoverage adapters: [istanbulCoberturaAdapter(path: '**/cobertura-coverage.xml', thresholds: [[failUnhealthy: true, thresholdTarget: 'Line', unhealthyThreshold: 20.0]])], sourceFileResolver: sourceFiles('STORE_LAST_BUILD')
